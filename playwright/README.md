...
> **Stack pin:** prod image tags с **`main`**; pin-ветки 2.x (`selenoid2-…-react16` / `react18`) — frozen rollback reference. Детали — [`STACK-PIN.md`](../STACK-PIN.md) на соответствующей ветке · [monorepo SSOT](https://github.com/qa-guru/zero-design-system/blob/master/projects/selenoid-home/README.md).
...
| `/opt/playwright/headed-window.cjs` | `--start-maximized` / `--window-size` для Chromium |
